...
public class DWRProgramLocationService {
    ...
    throws ParseException {
		org.openmrs.module.programlocation.PatientProgram pp = (org.openmrs.module.programlocation.PatientProgram)Context.getProgramWorkflowService().getPatientProgram(patientProgramId);
		Location loc = null;
		if(locationId != null) {
